...
export function DashboardScreenshotThumbs({
  ...
  const yellow = variant === "lightYellow";
  ...
  const thumbBtn = green
    ...
    : blue
      ...
      : orange
        ...
        : yellow
          ? "group flex items-center gap-3 rounded-xl border border-[#ebebeb] bg-[#f7f7f7] p-2 pr-3 text-left transition-colors hover:border-[#F5C518]/55 hover:bg-[#fdf8e6]"
          : light
  ...
  const titleCls = green
    ...
    : blue
      ...
      : orange
        ...
        : yellow
          ? "block text-xs font-semibold text-[#222222] group-hover:text-[#8a6d05]"
          : light
